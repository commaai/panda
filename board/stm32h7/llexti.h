...
void exti_irq_init(void) {
  if (car_harness_status == HARNESS_STATUS_FLIPPED) {
    ...
    REGISTER_INTERRUPT(EXTI1_IRQn, EXTI_IRQ_Handler, 100U, FAULT_INTERRUPT_RATE_DEEPSLEEP)
    NVIC_EnableIRQ(EXTI1_IRQn);
    REGISTER_INTERRUPT(EXTI15_10_IRQn, EXTI_IRQ_Handler, 100U, FAULT_INTERRUPT_RATE_DEEPSLEEP)
    ...
    REGISTER_INTERRUPT(EXTI4_IRQn, EXTI_IRQ_Handler, 100U, FAULT_INTERRUPT_RATE_DEEPSLEEP)

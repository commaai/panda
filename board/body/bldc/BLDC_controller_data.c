...
#ifdef STM32F4
P rtP_Left = {
  12288, 40, 20, 0, 2000, 10667U, 9600U, 1280U, 14400,
  ...
  400, 12000, 4000, 240, 480, 6400, 4800, 16000, 48, 9600, 16000, 12000,
  768U, 819U, 1229U, 4833U, 7864U, 737U, 1229U, 737U, 251U, 246U,
  15U, 2U, 0U, 0, 0, 1, 0
};
#else
P rtP_Left = {

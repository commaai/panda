        ...
        switch (UnitDelay3) {
         ...
         case 1:
          ...
          PI_clamp_fixdt_l((int16_T)rtb_Gain3, rtP->cf_nKp, rtP->cf_nKi,
                           ...
                           (int16_T)(rtb_TmpSignalConversionAtLow_Pa[0] - ff),
                           (int16_T)(rtb_TmpSignalConversionAtLow_Pa[1] - ff), rtDW->Divide1,
                           &rtDW->Merge, &rtDW->PI_clamp_fixdt_l4);

          {
             int32_t out = rtDW->Merge + ff;
             if (out > rtb_TmpSignalConversionAtLow_Pa[0]) {
               out = rtb_TmpSignalConversionAtLow_Pa[0];
             } else if (out < rtb_TmpSignalConversionAtLow_Pa[1]) {
               out = rtb_TmpSignalConversionAtLow_Pa[1];
             }

...
// Speed control mode defined by the generated controller.
#define SPD_MODE 2U
#include "rtwtypes.h"
...
static RT_MODEL *const rtM_Left = &rtM_Left_Obj;
static RT_MODEL *const rtM_Right = &rtM_Right_Obj;
...
static const adc_signal_t adc_curL_phaA = ADC_CHANNEL_BLDC(ADC2, 10);
static const adc_signal_t adc_curL_phaC = ADC_CHANNEL_BLDC(ADC2, 11);
static const adc_signal_t adc_curL_DC = ADC_CHANNEL_BLDC(ADC2, 18);
static const adc_signal_t adc_curR_phaA = ADC_CHANNEL_BLDC(ADC1, 7);
static const adc_signal_t adc_curR_phaC = ADC_CHANNEL_BLDC(ADC1, 15);
static const adc_signal_t adc_curR_DC = ADC_CHANNEL_BLDC(ADC1, 5);
static const adc_signal_t adc_batVoltage = ADC_CHANNEL_BLDC(ADC1, 4);

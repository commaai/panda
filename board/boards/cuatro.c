...
static void cuatro_set_can_mode(uint8_t mode) {
  cuatro_enable_can_transceiver(2U, false);
  cuatro_enable_can_transceiver(4U, false);
  switch (mode) {
    ...
    case CAN_MODE_OBD_CAN2:
      if ((bool)(mode == CAN_MODE_NORMAL) != (bool)(harness.status == HARNESS_STATUS_FLIPPED)) {
        ...
        cuatro_enable_can_transceiver(2U, true);
      } else {
        ...
        cuatro_enable_can_transceiver(4U, true);
      }
      break;
    default:
      break;

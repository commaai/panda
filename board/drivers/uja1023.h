...
void uja1023_init(int addr) {
  ...
  //LIN_SendData(&LIN_RING, &assign_id_frame);
  //LIN_ReceiveData(&LIN_RING, &frame_to_receive);
  ...
  //LIN_SendData(&LIN_RING, &io_cfg_1_frame);
  //LIN_ReceiveData(&LIN_RING, &frame_to_receive);
  ...
  //LIN_SendData(&LIN_RING, &io_cfg_2_frame);
  //LIN_ReceiveData(&LIN_RING, &frame_to_receive);
  ...
  //LIN_SendData(&LIN_RING, &io_cfg_3_frame);
  //LIN_ReceiveData(&LIN_RING, &frame_to_receive);
  ...
  io_cfg_4_frame.data[0]  = addr; //D0, slave node address (NAD) (default 0x60)
  ...
  LIN_SendData(&LIN_RING, &io_cfg_4_frame);
  LIN_ReceiveData(&LIN_RING, &frame_to_receive);*/

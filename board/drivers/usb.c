...
extern int comms_control_handler(ControlPacket_t *req, uint8_t *resp);
extern int comms_can_read(uint8_t *data, uint32_t max_len);
extern void comms_can_write(uint8_t *data, uint32_t len);
extern void comms_endpoint2_write(uint8_t *data, uint32_t len);

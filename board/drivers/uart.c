...
#define UART_BUFFER_IMPL(x, size_rx, size_tx, uart_ptr, callback_ptr, overwrite_mode) \
...
// debug = USART2
UART_BUFFER_IMPL(debug, FIFO_SIZE_INT, FIFO_SIZE_INT, USART2, debug_ring_callback, true)

// SOM debug = UART7
UART_BUFFER_IMPL(som_debug, FIFO_SIZE_INT, FIFO_SIZE_INT, UART7, NULL, true)

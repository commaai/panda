...
// Internal macro definition for UART buffers
#define UART_BUFFER_DEF(x, size_rx, size_tx, uart_ptr, callback_ptr, overwrite_mode) \
...
// UART buffer instances
UART_BUFFER_DEF(debug, FIFO_SIZE_INT, FIFO_SIZE_INT, USART2, debug_ring_callback, true)
UART_BUFFER_DEF(som_debug, FIFO_SIZE_INT, FIFO_SIZE_INT, UART7, NULL, true)

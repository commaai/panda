...
void pwm_init(TIM_TypeDef *TIM, uint8_t channel){
  ...
  switch(channel){
    case 1U:
      ...
      break;
    case 2U:
      register_set_bits(&(TIM->CCMR1), (TIM_CCMR1_OC2M_2 | TIM_CCMR1_OC2M_1 | TIM_CCMR1_OC1PE));
      register_set_bits(&(TIM->CCER), TIM_CCER_CC2E);
      break;
    case 3U:
      register_set_bits(&(TIM->CCMR2), (TIM_CCMR2_OC3M_2 | TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC1PE));
      register_set_bits(&(TIM->CCER), TIM_CCER_CC3E);
      break;
    case 4U:
      register_set_bits(&(TIM->CCMR2), (TIM_CCMR2_OC4M_2 | TIM_CCMR2_OC4M_1 | TIM_CCMR2_OC1PE));

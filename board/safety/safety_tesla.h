...
RxCheck tesla_rx_checks[] = {
  {.msg = {{0x2b9, 2, 8, .expected_timestep = 25U}, { 0 }, { 0 }}},   // DAS_control (25Hz)
  {.msg = {{0x370, 0, 8, .expected_timestep = 25U}, { 0 }, { 0 }}},   // EPAS_sysStatus (25Hz)
  {.msg = {{0x108, 0, 8, .expected_timestep = 100U}, { 0 }, { 0 }}},   // DI_torque1 (100Hz)
  {.msg = {{0x118, 0, 6, .expected_timestep = 100U}, { 0 }, { 0 }}},   // DI_torque2 (100Hz)
  {.msg = {{0x20a, 0, 8, .expected_timestep = 50U}, { 0 }, { 0 }}},   // BrakeMessage (50Hz)
  {.msg = {{0x368, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},  // DI_state (10Hz)
  {.msg = {{0x318, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},  // GTW_carState (10Hz)
};

RxCheck tesla_pt_rx_checks[] = {
  {.msg = {{0x106, 0, 8, .expected_timestep = 100U}, { 0 }, { 0 }}},   // DI_torque1 (100Hz)
  {.msg = {{0x116, 0, 6, .expected_timestep = 100U}, { 0 }, { 0 }}},   // DI_torque2 (100Hz)
  {.msg = {{0x1f8, 0, 8, .expected_timestep = 50U}, { 0 }, { 0 }}},   // BrakeMessage (50Hz)
  {.msg = {{0x2bf, 2, 8, .expected_timestep = 25U}, { 0 }, { 0 }}},   // DAS_control (25Hz)
  {.msg = {{0x256, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},  // DI_state (10Hz)
};

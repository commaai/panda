...
RxCheck gm_rx_checks[] = {
  {.msg = {{0x184, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},
  {.msg = {{0x34A, 0, 5, .expected_timestep = 10U}, { 0 }, { 0 }}},
  {.msg = {{0x1E1, 0, 7, .expected_timestep = 10U}, { 0 }, { 0 }}},
  {.msg = {{0xBE, 0, 6, .expected_timestep = 10U},    // Volt, Silverado, Acadia Denali
           {0xBE, 0, 7, .expected_timestep = 10U},    // Bolt EUV
           {0xBE, 0, 8, .expected_timestep = 10U}}},  // Escalade
  {.msg = {{0x1C4, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},
  {.msg = {{0xC9, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},
};

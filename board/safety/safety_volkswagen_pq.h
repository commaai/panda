...
const int VOLKSWAGEN_PQ_MAX_RT_DELTA = 113;             // 6 max rate up * 50Hz send rate * 250000 RT interval / 1000000 = 75 ; 125 * 1.5 for safety pad = 113
const uint32_t VOLKSWAGEN_PQ_RT_INTERVAL = 250000;      // 250ms between real time checks
const int VOLKSWAGEN_PQ_MAX_RATE_UP = 6;                // 3.0 Nm/s RoC limit (EPS rack has own soft-limit of 5.0 Nm/s)

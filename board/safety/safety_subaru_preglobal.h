...
RxCheck subaru_preglobal_rx_checks[] = {
  {.msg = {{MSG_SUBARU_PG_Throttle,        SUBARU_PG_MAIN_BUS, 8, .expected_timestep = 100U}, { 0 }, { 0 }}},
  {.msg = {{MSG_SUBARU_PG_Steering_Torque, SUBARU_PG_MAIN_BUS, 8, .expected_timestep = 50U}, { 0 }, { 0 }}},
  {.msg = {{MSG_SUBARU_PG_CruiseControl,   SUBARU_PG_MAIN_BUS, 8, .expected_timestep = 20U}, { 0 }, { 0 }}},
};

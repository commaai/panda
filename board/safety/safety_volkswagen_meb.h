...
const CanMsg VOLKSWAGEN_MEB_LONG_TX_MSGS[] = {{MSG_MEB_ACC_02, 0, 32}, {MSG_HCA_03, 0, 24}, {MSG_LDW_02, 0, 8}, {MSG_LH_EPS_03, 2, 8}};
...
static uint32_t volkswagen_meb_compute_crc(const CANPacket_t *to_push) {
  ...
  if (addr == MSG_LH_EPS_03) {
    ...
    crc ^= (uint8_t[]){0x1A,0x65,0x81,0x96,0xC0,0xDF,0x11,0x92,0xD3,0x61,0xC6,0x95,0x8C,0x29,0x21,0xB5}[counter];
  }else {

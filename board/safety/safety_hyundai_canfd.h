...
static safety_config hyundai_canfd_init(uint16_t param) {
  ...
  // Surppressing warnings, if the variable was declared inside if-else, readability would be compromised
  ...
  static const int HYUNDAI_PARAM_CANFD_ALT_BUTTONS = 32;
  static const int HYUNDAI_PARAM_CANFD_HDA2_ALT_STEERING = 128;
...
// Implementation limit, all of the functions should be declared as extern, and their implementation should be

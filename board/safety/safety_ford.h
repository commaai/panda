...
RxCheck ford_rx_checks[] = {
  {.msg = {{FORD_BrakeSysFeatures, 0, 8, .check_checksum = true, .max_counter = 15U, .quality_flag=true, .expected_timestep = 50U}, { 0 }, { 0 }}},
  // TODO: FORD_EngVehicleSpThrottle2 has a counter that skips by 2, understand and enable counter check
  {.msg = {{FORD_EngVehicleSpThrottle2, 0, 8, .check_checksum = true, .quality_flag=true, .expected_timestep = 50U}, { 0 }, { 0 }}},
  {.msg = {{FORD_Yaw_Data_FD1, 0, 8, .check_checksum = true, .max_counter = 255U, .quality_flag=true, .expected_timestep = 100U}, { 0 }, { 0 }}},
  // These messages have no counter or checksum
  {.msg = {{FORD_EngBrakeData, 0, 8, .expected_timestep = 10U}, { 0 }, { 0 }}},
  {.msg = {{FORD_EngVehicleSpThrottle, 0, 8, .expected_timestep = 100U}, { 0 }, { 0 }}},
  {.msg = {{FORD_DesiredTorqBrk, 0, 8, .expected_timestep = 50U}, { 0 }, { 0 }}},
};

...
RxCheck nissan_rx_checks[] = {
  {.msg = {{0x2, 0, 5, .expected_timestep = 100U},
           {0x2, 1, 5, .expected_timestep = 100U}, { 0 }}},  // STEER_ANGLE_SENSOR (100Hz)
  {.msg = {{0x285, 0, 8, .expected_timestep = 50U},
           {0x285, 1, 8, .expected_timestep = 50U}, { 0 }}}, // WHEEL_SPEEDS_REAR (50Hz)
  {.msg = {{0x30f, 2, 3, .expected_timestep = 10U},
           {0x30f, 1, 3, .expected_timestep = 10U}, { 0 }}}, // CRUISE_STATE (10Hz)
  {.msg = {{0x15c, 0, 8, .expected_timestep = 50U},
           {0x15c, 1, 8, .expected_timestep = 50U},
           {0x239, 0, 8, .expected_timestep = 50U}}}, // GAS_PEDAL (100Hz / 50Hz)
  {.msg = {{0x454, 0, 8, .expected_timestep = 10U},
           {0x454, 1, 8, .expected_timestep = 10U},
           {0x1cc, 0, 4, .expected_timestep = 100U}}}, // DOORS_LIGHTS (10Hz) / BRAKE (100Hz)
};

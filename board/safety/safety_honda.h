...
#define HONDA_COMMON_NO_SCM_FEEDBACK_RX_CHECKS(pt_bus)                                                                                           \
  {.msg = {{0x1A6, (pt_bus), 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 25U},                  /* SCM_BUTTONS */      \
           {0x296, (pt_bus), 4, .check_checksum = true, .max_counter = 3U, .expected_timestep = 25U}, { 0 }}},                                \
  {.msg = {{0x158, (pt_bus), 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 100U}, { 0 }, { 0 }}},  /* ENGINE_DATA */      \
  {.msg = {{0x17C, (pt_bus), 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 100U}, { 0 }, { 0 }}},  /* POWERTRAIN_DATA */  \

#define HONDA_COMMON_RX_CHECKS(pt_bus)                                                                                                         \
  HONDA_COMMON_NO_SCM_FEEDBACK_RX_CHECKS(pt_bus)                                                                                               \
  {.msg = {{0x326, (pt_bus), 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 10U}, { 0 }, { 0 }}},  /* SCM_FEEDBACK */  \
...
#define HONDA_ALT_BRAKE_ADDR_CHECK(pt_bus)                                                                                                    \
  {.msg = {{0x1BE, (pt_bus), 3, .check_checksum = true, .max_counter = 3U, .expected_timestep = 50U}, { 0 }, { 0 }}},  /* BRAKE_MODULE */  \

...
const CanMsg HONDA_RADARLESS_TX_MSGS[] = {{0xE4, 0, 5}, {0x296, 2, 4}, {0x33D, 0, 8}, {0x1C8, 0, 8}};  // Bosch radarless
const CanMsg HONDA_RADARLESS_LONG_TX_MSGS[] = {{0xE4, 0, 5}, {0x296, 2, 4}, {0x33D, 0, 8}, {0x1C8, 0, 8}};  // Bosch radarless w/ gas and brakes
...
static int honda_bosch_fwd_hook(int bus_num, CANPacket_t *to_fwd) {
  ...
  if (bus_num == 2)  {
    ...
    int is_acc_msg = honda_bosch_radarless && (addr == 0x1C8);

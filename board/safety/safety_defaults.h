...
static int nooutput_tx_hook(CANPacket_t *to_send, bool current_controls_allowed, bool longitudinal_allowed) {
  UNUSED(to_send);
  UNUSED(current_controls_allowed);
...
static int alloutput_tx_hook(CANPacket_t *to_send, bool current_controls_allowed, bool longitudinal_allowed) {
  UNUSED(to_send);
  UNUSED(current_controls_allowed);
  UNUSED(longitudinal_allowed);
  return true;

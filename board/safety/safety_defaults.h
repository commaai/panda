...
static int nooutput_tx_hook(CANPacket_t *to_send, bool current_controls_allowed) {
  UNUSED(to_send);
...
static int alloutput_tx_hook(CANPacket_t *to_send, bool current_controls_allowed) {
  UNUSED(to_send);
  UNUSED(current_controls_allowed);
  return true;
}

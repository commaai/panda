...
AddrCheckStruct hyundai_rx_checks[] = {
  {.addr = {608}, .bus = 0, .length = {8}, .max_counter = 3U, .expected_timestep = 10000U},
  {.addr = {897}, .bus = 0, .length = {8}, .max_counter = 255U, .expected_timestep = 10000U},
  {.addr = {902}, .bus = 0, .length = {8}, .max_counter = 3U,  .expected_timestep = 10000U},
  {.addr = {916}, .bus = 0, .length = {8}, .max_counter = 7U, .expected_timestep = 10000U},
  {.addr = {1057}, .bus = 0, .length = {8}, .max_counter = 15U, .expected_timestep = 20000U},
};

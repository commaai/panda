...
AddrCheckStruct TOYOTA_RX_CHECKS[] = {
  {.addr = {0x260}, .addr_len = 1U, .bus = 0, .check_checksum = true, .max_counter = 0U, .expected_timestep = 20000U},
  {.addr = {0x1D2}, .addr_len = 1U, .bus = 0, .check_checksum = true, .max_counter = 0U, .expected_timestep = 30000U},
};

...
static int volkswagen_mqb_tx_hook(CANPacket_t *to_send, bool current_controls_allowed, bool longitudinal_allowed) {
  ...
  if ((addr == MSG_GRA_ACC_01) && !current_controls_allowed) {

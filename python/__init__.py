...
class Panda:
  ...
  H7_DEVICES = (HW_TYPE_RED_PANDA, HW_TYPE_PURPLE_PANDA)

  INTERNAL_DEVICES = (HW_TYPE_UNO, HW_TYPE_DOS)
  HAS_OBD = (HW_TYPE_BLACK_PANDA, HW_TYPE_UNO, HW_TYPE_DOS, HW_TYPE_RED_PANDA, HW_TYPE_PURPLE_PANDA)

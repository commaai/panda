...
class Panda:
  ...
  # first byte is for max actuation torque
  FLAG_HYUNDAI_EV_GAS = (1 << 8)
  FLAG_HYUNDAI_HYBRID_GAS = (2 << 8)
  FLAG_HYUNDAI_LONG = (4 << 8)
  FLAG_HYUNDAI_CAMERA_SCC = (8 << 8)
  FLAG_HYUNDAI_CANFD_HDA2 = (8 << 8)
  FLAG_HYUNDAI_CANFD_ALT_BUTTONS = (16 << 8)

        ...
        if attr.startswith("Test") and attr != current_test:
          ...
          if tx is not None and not attr.endswith('Base'):
            ...
            if attr.startswith('TestToyota') and current_test.startswith('TestToyota'):
              continue
            if {attr, current_test}.issubset({'TestSubaruGen1TorqueStockLongitudinalSafety', 'TestSubaruGen2TorqueStockLongitudinalSafety', 'TestSubaruGen1LongitudinalSafety'}):
              continue

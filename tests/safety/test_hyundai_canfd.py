...
class TestHyundaiCanfd(HyundaiButtonBase, common.PandaSafetyTest, common.DriverTorqueSteeringSafetyTest):
  ...
  def setUp(self):
    self.packer = CANPackerPanda("hyundai_tucson_hev_2022")
  ...
  def _torque_cmd_msg(self, torque, steer_req=1):
    ...
    return self.packer.make_can_msg_panda("LFA", 0, values)
...
class TestHyundaiCanfdHDA2(TestHyundaiCanfd):

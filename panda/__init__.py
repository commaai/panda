...
from .constants import BASEDIR, USBPACKET_MAX_SIZE  # noqa: F401
from .constants import FW_PATH, McuType, compute_version_hash, FIRMWARE_PATH
from .dfu import PandaDFU
from .spi import STBootloaderSPIHandle  # noqa: F401
...
class Panda:
  ...
  HEALTH_PACKET_VERSION = compute_version_hash(os.path.join(FIRMWARE_PATH, "health.h"))
  HEALTH_STRUCT = _parse_c_struct(os.path.join(FIRMWARE_PATH, "health.h"), "health_t")
...
from .jungle import PandaJungle  # noqa: F401

...
At the user's request, played the exact stereo music file from the action-camera iPhone test through USB AirPods Max. The comma four announced a spoken countdown, then captured 58 seconds at native 48 kHz, including 45 seconds of music and quiet margins. Same pop-fix firmware, no EQ or denoising. The open earcup remained near the USB corner of the flat device; PC sink volume read 100% and was not changed by the controller. Music file peak was 0.2 full scale.
...
This placement did not improve the recovered high-frequency music. The AirPods capture's 4–8 and 8–12 kHz bands were only 1.95 and 0.95 dB above the post-music quiet interval, versus 17.47 and 11.47 dB in the earlier iPhone capture. Its 16–18 and 18–20 kHz bands were 0.63 and 0.77 dB above quiet. The 500–2000 Hz music band was also 7.24 dB lower in absolute level than the earlier iPhone capture. Post-music room noise differed, so these are descriptive band comparisons, not calibrated SNR measurements.

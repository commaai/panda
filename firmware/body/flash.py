...
FIRMWARE_DIR = os.path.abspath(os.path.join(BODY_DIR, ".."))
REPO_ROOT = os.path.abspath(os.path.join(FIRMWARE_DIR, ".."))
DEFAULT_FIRMWARE = os.path.join(FIRMWARE_DIR, "obj", "body_h7.bin.signed")


def build_body() -> None:
  subprocess.check_call(
    f"scons -C {REPO_ROOT} -j$(nproc) firmware/obj/body_h7.bin.signed",
    shell=True,
  )

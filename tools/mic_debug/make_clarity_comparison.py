...
def main():
  ...
  variants = [('original', 'Original', original), ('gentle', 'Gentle EQ', mild), ('stronger', 'Stronger EQ', strong), ('harmonics', 'Gentle EQ + synthetic harmonics', mild + added), ('subtle', 'Gentle EQ + subtler harmonics', mild + subtle_wet * subtle_gain)]
